      ...
      <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12">
        ...
        <div className="space-y-8">
          <div className="text-center md:text-left">
            ...
            <p className="mt-2 text-gray-600">Join our platform and streamline your medical practice</p>
          </div>
          
          <div className="grid gap-6">
            <div className="bg-white p-6 rounded-lg shadow-md">
              <h3 className="text-xl font-semibold text-gray-800 mb-2">Manage Appointments</h3>
              <p className="text-gray-600">
                Easily manage your appointments and view your schedule in one place.
              </p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-md">
              <h3 className="text-xl font-semibold text-gray-800 mb-2">Access Patient Records</h3>
              <p className="text-gray-600">
